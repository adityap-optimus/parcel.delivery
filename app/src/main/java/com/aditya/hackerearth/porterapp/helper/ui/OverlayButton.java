...
public class OverlayButton extends ImageButton {
    ...
    void init(Context context, AttributeSet attributeSet) {
        TypedArray attr = context.obtainStyledAttributes(attributeSet, R.styleable.OverlayButton, 0, 0);
        mColorNormal = attr.getColor(R.styleable.OverlayButton_ob_colorNormal, getColor(android.R.color.holo_blue_dark));
        mColorPressed = attr.getColor(R.styleable.OverlayButton_ob_colorPressed, getColor(android.R.color.holo_blue_light));
        mColorDisabled = attr.getColor(R.styleable.OverlayButton_ob_colorDisabled, getColor(android.R.color.darker_gray));
        mIcon = attr.getResourceId(R.styleable.OverlayButton_ob_icon, 0);
        mStrokeVisible = true;
        attr.recycle();

        updateCircleSize();
        mShadowRadius = getDimension(R.dimen.ob_shadow_radius);
        mShadowOffset = getDimension(R.dimen.ob_shadow_offset);
        updateDrawableSize();
    ...
    private void updateCircleSize() {
        mCircleSize = getDimension(R.dimen.ob_size_normal);
    }
    ...
    TextView getLabelView() {
        return (TextView) getTag(R.id.ob_label);
    }
    ...
    void updateBackground() {
        final float strokeWidth = getDimension(R.dimen.ob_stroke_width);
        final float halfStrokeWidth = strokeWidth / 2f;

        LayerDrawable layerDrawable = new LayerDrawable(
                new Drawable[]{
                        getResources().getDrawable(R.drawable.bg_overlay_normal),
                        createFillDrawable(strokeWidth),
                        createOuterStrokeDrawable(strokeWidth),
                        getIconDrawable()
                });

        int iconOffset = (int) (mCircleSize - getDimension(R.dimen.ob_icon_size)) / 2;
